...
Yngin is a game engine project that I'm building for fun. This is a personal project that I work on in my free time.
...
## Supported Platforms
At the moment, Windows is the only supported platform.
...
- Thanks to [Font Awesome](https://fontawesome.com/) for providing the icons in the editor and [IconFontCppHeaders](https://github.com/juliettef/IconFontCppHeaders) for the header file
